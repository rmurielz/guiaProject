...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_tercero', models.CharField(choices=[('cliente', 'Cliente'), ('proveedor', 'Proveedor'), ('empleado', 'Empleado'), ('contratista', 'Contratista'), ('entidadregulatoria', 'Entidad Regulatoria'), ('entidadfinanciera', 'Entidad Financiera')], max_length=20, verbose_name='Tipo de Tercero')),
                ('tipo_identificacion', models.CharField(choices=[('cedula', 'Cédula de Ciudadanía'), ('nit', 'NIT'), ('ruc', 'RUC'), ('tarjetaidentidad', 'Tarjeta de Identidad'), ('cedulaextranjeria', 'Cédula de Extranjería'), ('pasaporte', 'Pasaporte')], max_length=30, verbose_name='Tipo ID')),
